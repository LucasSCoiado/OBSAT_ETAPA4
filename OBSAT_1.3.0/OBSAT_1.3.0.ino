...
double getAceleracao(int eixo){
  ...
  return Serial.print("Aceleracao X: " +(String)a.acceleration.x+", aceleracao Y: "+(String)a.acceleration.y+" e por fim Z: "+(String)a.acceleration.z);
}
...
double getGiroscopio(int eixo){
  ...
  return Serial.print("Giro X: " +(String)b.gyro.x+", giro Y: " +(String)b.gyro.y+" e Z: " +(String)b.gyro.z);
}
